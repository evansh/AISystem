...
//============================================================================
//
// FILE:	CompareValues-DevInit_F2806x.c
//
...
//  GPIO-01 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO1 = 3;		// 0=GPIO, 1=EPWM1B, 2=EMU (0), 3=COMP1OUT
...
//  GPIO-16 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX2.bit.GPIO16 = 3;	// 0=GPIO, 1=SPISIMOA, 2=Resv CAN-B, 3=TZ2n
...
//  GPIO-17 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX2.bit.GPIO17 = 3;	// 0=GPIO, 1=SPISOMIA, 2=Resv CAN-B, 3=TZ3n
